...
<nav id="menu"> 
		<ul>
		    ...
		    <a href="calendrier.php"><li <?php if ($page_en_cours == 'calendrier') {echo 'class="en_cours"';} ?>><i class="fas fa-calendar-alt fa-lg fa-fw"> </i><span>Calendrier</span></li></a>	
		    ...
		    <a href="profil.php"><li <?php if ($page_en_cours == 'parametre') {echo 'class="en_cours"';} ?>><i class="fas fa-cogs fa-lg fa-fw"> </i><span>Parametres</span></li></a>
		</ul>
</nav>
